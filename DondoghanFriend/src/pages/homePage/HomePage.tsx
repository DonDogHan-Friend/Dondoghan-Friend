...
import { getThresholdSetting } from "@/quries/setting/setting.ts";
...
const HomePage = () => {
    ...
    const [thresholdKey, setThresholdKey] =
        useState<keyof Threshold>("threshold_safety");
    ...
    useEffect(() => {
        ...
        const keys = Object.keys(thresholdSettingData) as Array<
            keyof Threshold
        >;
    ...
    return (
        <SafeAreaView
            ...
            style={{ backgroundColor: threshold[thresholdKey].color }}>
            ...
            <View className="h-80 flex-row justify-center mt-2 bg-white rounded-t-[42px]">
                <Image
                    ...
                    source={threshold[thresholdKey].gif}
                />
            </View>
